...
public class InvokeCommandScriptBlockWinRMOperation extends WinRMOperation implements Serializable {
    private final String command;
    private final static String REMOTE_INVOKE_COMMAND_PATH = "/com/spcow/plugins/winrmclient/InvokeCommandScriptBlockWinRMOperation/Remote-Invoke-Command-ScriptBlock.ps1";

    @DataBoundConstructor
    public InvokeCommandScriptBlockWinRMOperation(String command) {
